...
public class ComponentSelector : ScriptableWizard
{
    ...
    static public void Draw<T>(string buttonName, T obj, OnSelectionCallback cb, bool editButton, params GUILayoutOption[] options) where T : Object
    {
        ...
        bool show = GUILayout.Button(buttonName, GUI.skin.GetStyle("DropDown"));
    ...
    private void OnGUI()
    {
        ...
        if (!mSearched)
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            bool search = GUILayout.Button("Show All", GUI.skin.GetStyle("LargeButton"), GUILayout.Width(120f));
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            if (search) Search();
        }
    ...
    private bool DrawObject(Object obj)
    {
        ...
        GUILayout.BeginHorizontal();
        {
            ...
            retVal |= GUILayout.Button(obj.name, GUI.skin.textArea, GUILayout.Width(160f), GUILayout.Height(20f));
            retVal |= GUILayout.Button(path.Replace("Assets/", ""), GUI.skin.textArea, GUILayout.Height(20f));
            GUI.contentColor = Color.white;

            retVal |= GUILayout.Button("Select", GUI.skin.GetStyle("ButtonLeft"), GUILayout.Width(60f), GUILayout.Height(16f));
        }
        GUILayout.EndHorizontal();
        return retVal;
    }
